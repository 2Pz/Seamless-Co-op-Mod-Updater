...
<html>
    ...
    <body>
        ...
        <h2>Need Help?</h2>
        <p>If you encounter any issues or have questions, please don't hesitate to visit <a href=https://www.nexusmods.com/eldenring/mods/6613?tab=posts">Nexusmods Page</a> for support and the latest information.</p>
